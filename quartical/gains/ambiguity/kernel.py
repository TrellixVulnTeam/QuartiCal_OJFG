...
@generated_jit(nopython=True,
               ...
               cache=True,
               nogil=True)
def ambiguity_solver(base_args, term_args, meta_args, corr_mode):

    coerce_literal(ambiguity_solver, ["corr_mode"])
        ...
        for i in prange(n_int):
            ...
            for row_ind in range(rs, re):
                ...
                for f in range(fs, fe):
                    ...
                    rm_f = f_map_arr_g[f, active_term]
                    ...
                    for a in range(n_ant):
                        for d in range(n_dir):
                            ...
                            if fl == 1:
                                ...
                                gain[t, f, a, d, 1] = 1j*sin_theta
                                gain[t, f, a, d, 2] = 1j*sin_theta
                                gain[t, f, a, d, 3] = cos_theta
    else:
        raise ValueError("Rotations can only be solved for with four "
                         "correlation data.")
